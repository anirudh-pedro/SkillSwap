...
{/* Orb with hover functionality - middle layer with event capture */}
<div className="fixed inset-0 w-full h-full overflow-hidden z-5" 
     onMouseMove={(e) => console.log("Mouse moved on orb container", e.clientX, e.clientY)}>
  <Orb
    hoverIntensity={0.4}
    rotateOnHover={true}
    hue={280}
...
{/* Login form - top layer with pointer events that don't pass through */}
<div className="fixed inset-0 flex items-center justify-center p-4 z-20 pointer-events-none">
  <div className="w-full max-w-md rounded-xl bg-black/10 backdrop-blur-md shadow-lg border border-white/40 pointer-events-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 p-6 pt-0">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full rounded-lg bg-gradient-to-r from-purple-500 to-pink-500 px-4 py-2 text-center font-medium text-white shadow-lg hover:from-purple-600 hover:to-pink-600 focus:outline-none focus:ring-4 focus:ring-purple-500/50 disabled:opacity-70"
            >
              {isLoading ? (
                <div className="flex items-center justify-center">
